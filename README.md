...
| _pico flexx_ | X | The [pico flexx](http://pmdtec.com/picoflexx) is a small USB 3D sensor made by [pmdtechnologies](http://pmdtec.com) that allows capturing of live 3D data. |
